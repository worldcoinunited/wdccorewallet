...
const QString WitcoinGUI::DEFAULT_WALLET = "~Default";
    ...
    prevBlocks(0)
{
    ...
    if (!fIsTestnet)
    {
        ...
        QApplication::setWindowIcon(QIcon(":icons/worldcoin"));
        setWindowIcon(QIcon(":icons/worldcoin"));
    }
    else
    {
        setWindowTitle(tr("Worldcoin") + " - " + tr("Wallet") + " " + tr("[testnet]"));
        QApplication::setWindowIcon(QIcon(":icons/worldcoin_testnet"));
        setWindowIcon(QIcon(":icons/worldcoin_testnet"));
    }
#else
    ...
    if (!fIsTestnet)
        MacDockIconHandler::instance()->setIcon(QIcon(":icons/worldcoin"));
    else
        MacDockIconHandler::instance()->setIcon(QIcon(":icons/worldcoin_testnet"));
#endif
    // Accept D&D of URIs
    setAcceptDrops(true);
...
void BitcoinGUI::createActions(bool fIsTestnet)
{
  ...
  //  connect(ui->bNewMessage, SIGNAL(clicked()), this, SLOT(showNormalIfMinimized()));
    ...
    if (!fIsTestnet)
        aboutAction = new QAction(QIcon(":/icons/worldcoin"), tr("&About Worldcoin"), this);
    else
        aboutAction = new QAction(QIcon(":/icons/worldcoin_testnet"), tr("&About Worldcoin"), this);
    ...
    if (!fIsTestnet)
        toggleHideAction = new QAction(QIcon(":/icons/worldcoin"), tr("&Show / Hide"), this);
    else
        toggleHideAction = new QAction(QIcon(":/icons/worldcoin_testnet"), tr("&Show / Hide"), this);
...
void BitcoinGUI::askFee(qint64 nFeeRequired, bool *payFee)
{
    QString strMessage = tr("This transaction is over the size limit. You can still send it for a fee of %1, "
        ...
        "Do you want to pay the fee?").arg(BitcoinUnits::formatWithUnit(BitcoinUnits::WDC, nFeeRequired));
