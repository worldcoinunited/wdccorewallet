...
static Checkpoints::MapCheckpoints mapCheckpoints =
        boost::assign::map_list_of
			...
			( 1972653, uint256("0xe692876261f0e9b0b32cb63a8d6ef284c6c32348cd91079e56a984a3396e8eda"))
        ;
static const Checkpoints::CCheckpointData data = {
        &mapCheckpoints,
		      1434637043, // * UNIX timestamp of last checkpoint block
        3687173,    // * total number of transactions between genesis and last checkpoint
...
static Checkpoints::MapCheckpoints mapCheckpointsRegtest =
        boost::assign::map_list_of
        ( 0, uint256("0f9188f13cb7b2c71f2a335e3a4fc328bf5beb436012afca590b1a11466e2206"))	// Not updated for Worldcoin
        ;
...
public:
    CMainParams() {
        ...
        nMinerThreads = 0;
        nTargetTimespan =  0.35 *24 * 60 * 60; //  Worldcoin: 0.35 day
        nTargetSpacing = 15;						// Worldcoin: 15 sec
        ...
        // Worldcoin: Mainnet v2 enforced as of block 1300500 (6/1/2014)
